...
//    private int statusHeight = -1, navBarHeight = -1;
...
//            navBarHeight = getNavigationBarHeight(context);
//            Log.d("hebing", "Screen resolution: " + statusHeight + "-" + navBarHeight);
//        }
    }

//    public static int getNavigationBarHeight(Context contex) {
//        if (!checkDeviceHasNavigationBar(contex)) {
//            return 0;
//        }
...
//    void initStatusBar(Context contex) {
//        Class<?> c = null;
//        Object obj = null;
//        Field field = null;
//        int x = 0, sbar = 0;
...
//        } catch (Exception e1) {
//            Log.i("here", "get status bar height fail", e1);
//        }
//    }
