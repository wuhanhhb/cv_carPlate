...
package com.cv.emmp_ard.scan.camera;
...
public final class CameraManager {
    ...
    public void setSurfaceSize(int width, int height) {
        mSurfaceViewSize = new Point(width, height);
    }

    public Point getSurfaceViewSize() {
        if (mSurfaceViewSize == null) {
            return configManager.getScreenResolution();
        } else {
            return mSurfaceViewSize;
        }
    }

    private Point mSurfaceViewSize;
    ...
    public void setScanMode(SCAN_MODEL mode) {
        switch (mode) {
            case BARCODE:
                mAspect = 0.5f;
                break;
    ...
    public Rect getFramingRect() {
        Point screenResolution = getSurfaceViewSize();//configManager.getScreenResolution();
        if (framingRect == null) {
            if (camera == null) {
                return null;
            }
...
//            int width = (int) (metrics.widthPixels * 0.7);
            ...
            if (CarPlateDetection.TEST) {
                width = (int) (screenResolution.x >> 1);
                height = (int) (width * mAspect + 1);
                //height = (int) (width * mAspect);
            } else {
                width = (int) (screenResolution.x * .7f + 1);
                height = (int) (width * mAspect + 1);
            }
            ...
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
                    topOffset + height);
            Log.d("hx", "Calculated framing rect: " + framingRect);
        }
        return framingRect;
    }
    ...
    public Rect getFramingRectInPreview() {
        if (framingRectInPreview == null) {
            ...
            Log.d("hx", "Calculated framingRectInPreview rect: "
                    + framingRectInPreview + "," + cameraResolution + "," + screenResolution);
        }
